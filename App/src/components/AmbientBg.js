      ...
      <Svg width="100%" height="100%" style={{ position: 'absolute' }}>
        <Defs>
          <LinearGradient id="bg" x1="0" y1="0" x2="0" y2="1">
            ...
            <Stop offset="60%" stopColor={theme.bgB} />
            <Stop offset="100%" stopColor={theme.bgC} />
          </LinearGradient>
          <RadialGradient id="g1" cx="80%" cy="20%" r="65%">
            <Stop offset="0%" stopColor={statusColor || theme.s2} stopOpacity="0.25" />
            <Stop offset="60%" stopColor={statusColor || theme.s2} stopOpacity="0.06" />
          ...
          <RadialGradient id="g2" cx="25%" cy="85%" r="55%">
            ...
            <Stop offset="60%" stopColor={theme.accent} stopOpacity="0.04" />
            <Stop offset="100%" stopColor={theme.accent} stopOpacity="0" />
          </RadialGradient>
          <RadialGradient id="g3" cx="40%" cy="40%" r="45%">
            <Stop offset="0%" stopColor={theme.bgC || theme.bgB} stopOpacity="0.18" />
            <Stop offset="60%" stopColor={theme.bgC || theme.bgB} stopOpacity="0.04" />
